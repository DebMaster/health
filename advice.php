                             ...
                             <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a href="newadvice.php">Add New</a>
                                        </li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                            <a href="advicedelete.php?id=<?php echo $id; ?>"><i class="fa fa-trash-o"></i></a>
                                            <a href="adviceupdate.php?id=<?php echo $id; ?>"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
